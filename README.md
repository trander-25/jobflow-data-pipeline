...
| --- | --- | --- |
| Bronze | `airflow/dbt_jobflow/models/bronze` | Source-aligned staging tables. |
| Silver | `airflow/dbt_jobflow/models/silver` | Cleaned and unified intermediate models. |
| Gold | `airflow/dbt_jobflow/models/gold` | Facts and dimensions for analytics. |
| Reports | `airflow/dbt_jobflow/models/reports` | Business-ready report tables. |
| Audit | `airflow/dbt_jobflow/models/audit` | Pipeline performance and ELT summary models. |
...
```bash
docker volume rm jobflow-data-pipeline_postgres_data
docker volume rm jobflow-data-pipeline_minio_data
```
